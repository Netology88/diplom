...
![Пример конфигурации](src/ansible-ping.png)
![Terraform инсталляция](src/inst-terraform.png)
...
![Веб-страница 1](src/scr-web1.png)
![Веб-страница 2](src/scr-web2.png)

3. Создайте Target Group и включите в неё две созданные ВМ.

![Target Group](src/target-group.png)
...
![Backend Group](src/http-router1.png)

5. Создайте HTTP router. Путь укажите — `/`, backend group — созданную ранее.

![HTTP Router](src/http-router.png)
...
![Load Balancer](src/load-balabcer.png)
![Load Balancer 2](src/load-b-1.png)
...
![Обзор 1](src/disc-vm-ya.png)
![Обзор 2](src/http-router.png)
![Обзор 3](src/http-router1.png)
![Обзор 4](src/ip-addr-ya.png)
![Обзор 5](src/route-tabl-ya.png)
![Обзор 6](src/security-group-ya.png)
![Обзор 7](src/subnet-ya.png)
![Обзор 8](src/vm-ya.png)
![Обзор 9](src/zone-vpc-1.png)
![Обзор 10](src/zone-vpc-2.png)
